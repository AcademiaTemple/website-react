...
const MainDescription = () => (
    <>
        ...
        <b>requisitos previos:  nociones básicas de programción (operadores booleanos,comandos de líneas y comandos shell y funciones variables) y es recomendable (No es indispensable) tener experiencia con base de datos relacionales (MySQL, Oracle).</b><br /><br />
